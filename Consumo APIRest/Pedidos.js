var UrlGetPedidos='http://localhost:80/G3_19/controller/pedidos.php?op=GetPedidos';
var UrlPostPedido='http://localhost:80/G3_19/controller/pedidos.php?op=InsertPedido';
var UrlGetUno='http://localhost:80/G3_19/controller/pedidos.php?op=GetUno';
var UrlPutPedido='http://localhost:80/G3_19/controller/pedidos.php?op=UpdatePedido';
var UrlDeletePedido='http://localhost:80/G3_19/controller/pedidos.php?op=DeletePedido';
